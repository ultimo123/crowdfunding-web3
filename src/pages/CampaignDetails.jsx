      ...
      <div className="w-full flex md:flex-row flex-col mt-10 gap-[30px]">
        <div className="flex-1 flex-col">
          <img
            src={state.image}
            alt="Img"
            className="w-full h-[408px] object-cover rounded-xl"
          />

          <div className="reelative w-full h-[5px] bg-[#3a3a43] mt-2">
            <div
              className="absolute h-full bg-[#4acdad]"
              style={{
                width: `${calculateBarPercentage(
                  state.target,
                  state.ammountCollected,
                )}%`,
                maxWidth: "100%",
              }}
            />
      ...
      <div className="mt-[60px] flex lg:flex-row flex-col gap-5">
        <div className="flex-[2] flex flex-col gap-[40px]">
          <div className="">
            ...
            <div className="mt-[20px] flex flex-row items-center flexwr4 gap-[14px]">
